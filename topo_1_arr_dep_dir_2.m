...
{'W-Y','Y-R1','R1-h','h-d','d-G1_en'}
{'S-Y','Y-R1','R1-h','h-d', 'd-e','e-G2_en'}    
{'W-Y','Y-R1','R1-h','h-d', 'd-e','e-G2_en'}
{'S-Y','Y-R1','R1-i','i-f','f-G3_en'}
{'W-Y','Y-R1','R1-i','i-f','f-G3_en'}
{'S-Y','Y-R1','R1-i','i-f','f-g','g-G4_en'}
{'W-Y','Y-R1','R1-i','i-f','f-g','g-G4_en'}
    };
...
{'G1_ex-a','a-b','b-c','c-R2','R2-X','X-E'};...
{'G2_ex-b','b-c','c-R2','R2-X','X-N'};...
{'G2_ex-b','b-c','c-R2','R2-X','X-E'};...
{'G3_ex-a','a-b','b-c','c-R2','R2-X','X-N'};...
{'G3_ex-a','a-b','b-c','c-R2','R2-X','X-E'};...
{'G4_ex-b','b-c','c-R2','R2-X','X-N'};...
{'G4_ex-b','b-c','c-R2','R2-X','X-E'};...
};
